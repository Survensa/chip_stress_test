...
class qa_logger(log_interface):
    ...
    def __init__(self) -> None:
        ...
        log = logging.getLogger(qa_logger.__name__)
    ...
    def info(self, msg):
        ...
        """
        #print ("stack frame {}".format(inspect.stack()[3].filename))
        self.log.info(msg)
...
class Log(log_interface):
    ...
    def info(self, msg):
        print ("caller_function_name = {}".format(inspect.currentframe().f_back.f_back.f_back.f_code.co_name))
